...
public class Problem1732 {
    ...
    Approach 1: iterative sum
    * intuition is to keep summing the altitude and update if it is > previous high
    algo:
    * init high=0,cur=0
    * iterate over gains
        * cur+= gain[i]
    ...
    * return high;
    ...
    public int largestAltitude(int[] gain) {
        return largestAltitudeA1(gain);
    }

    public int largestAltitudeA1(int[] gain) {
        int high = 0,cur=0;
